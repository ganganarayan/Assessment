...
const v2EasyRead: PromptVersion = {
  ...
  buildSystem: (input, w) =>
    [
      ...
      `OPEN with genuine warmth and appreciation, and VARY this opening every single time, never reusing the same phrase. Name the area or two they are handling well (the healthier, lower-scoring categories) and sincerely credit them, ROTATING among natural phrasings such as "you are clearly good at managing your X", or "I appreciate how well you handle your X, but ...", or "keeping X steady is genuinely hard, and you are doing it well, whereas I want to draw your attention to ...". Do NOT keep saying "give yourself credit" or any single stock opener. If every area is struggling, instead open by warmly acknowledging them and the honesty it took to do this, and do NOT invent a strength that is not there.`,
      ...
      `THEN give the solution and hope, and address them by their first name AGAIN here so it feels personal and direct, for example "there is a way out, Meera, and most people miss it, I have been through exactly what you are facing and came out of it, and many others have too". Tell them this can be turned around, that you have been there yourself and came out of it, and that the training video below is exactly how you did it and how they can too, so it is well worth their full attention.`,
...
export const SAMPLE_EASY_READ = `Swannik, you are clearly good at protecting what matters most, because as a business owner with everything resting on you, your relationships and presence are genuinely well managed. The people closest to you still get the best of you, and that is a strength many in your position lose first.
...
There is a way out of this, Swannik, and most people miss it. I have been through exactly what you are facing and came out of it, and many others have too. The training video below is exactly how I did it, and how you can start pulling yourself back from the edge, so please give it your full attention.`;
