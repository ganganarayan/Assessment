...
export async function createAssessment(
  ...
  const created = await prisma.assessment.create({
    data: {
      ...
      heatmapCode: nullifyEmpty(d.heatmapCode),
      ...
      resultsContinueUrl: nullifyEmpty(d.resultsContinueUrl),
...
export async function duplicateAssessment(id: string): Promise<ActionResult<{ id: string }>> {
  ...
  const created = await prisma.assessment.create({
    data: {
      ...
      professionPlaceholder: src.professionPlaceholder,
      leadCaptureAfter: src.leadCaptureAfter,
      introNotice: src.introNotice,
      startButtonLabel: src.startButtonLabel,
      resultsButtonLabel: src.resultsButtonLabel,
      ...
      resultsContinueUrl: src.resultsContinueUrl,
      resultsContinueLabel: src.resultsContinueLabel,
