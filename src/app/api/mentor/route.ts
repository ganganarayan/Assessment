...
/**
 * Gita Mentor read: returns a person's assessment RESULTS by email so the mentor
 * can personalize guidance.
 *
 *   GET /api/mentor?email=<>   Authorization: Bearer <token>   (scope=gita_mentor)
 *
