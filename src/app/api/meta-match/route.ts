...
/**
 * Secure, tenant-scoped lookup that returns a contact's Meta match signals so an
 * external CAPI sender (n8n) can build a strongly-attributed Purchase event.
 *
 *   GET /api/meta-match?email=<>&phone=<>   Authorization: Bearer <token>
 *
